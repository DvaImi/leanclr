...
function load_assembly_file(assembly_name,out_buf,out_size) { if (typeof Module.load_assembly_file == 'function') { return Module.load_assembly_file(assembly_name, out_buf, out_size); } console.error('load_assembly_file not implemented'); return 1; }
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createStartupModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createStartupModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createStartupModule);
