...
└── build/              # Build-related documentation
    ├── README.md       # Build documentation overview
    ├── build_runtime.md    # How to build the LeanCLR runtime
    └── embed_leanclr.md    # How to embed LeanCLR into your project
```
...
- [Demo: Win64](../demo/win64/README.md) - Windows x64 demo
- [Demo: HTML5](../demo/h5/README.md) - WebAssembly browser demo
